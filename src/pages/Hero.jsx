...
export default function Hero() {
    ...
    return (<div className="flex items-center justify-center min-h-screen px-4 py-4 text-white flex-wrap">
            <div
                className="
      flex flex-col items-center
      bg-[#1e293b]/60 backdrop-blur-lg border border-white/30
    ...
    ">
                ...
                <div className="flex flex-col lg:flex-row gap-4 lg:gap-6 w-full">
                    ...
                    <div className="flex flex-col gap-1 w-full max-w-xs">
                        ...
                        <input
                            ...
                            className="
            p-2 rounded-md bg-white/10 backdrop-blur-sm
          ...
          "
                ...
                <div className="flex flex-col sm:flex-row gap-4 sm:gap-6 justify-evenly items-center w-full">
